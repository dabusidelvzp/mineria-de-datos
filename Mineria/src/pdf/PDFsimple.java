...
public class PDFsimple {//comentario
    ...
    private static void agregarContenido(Document document,String titulo,String[][] arreglo,Integer N,Double b0,Double b1,Double Se,Double[] prediccion) throws DocumentException {
        ...
        if(prediccion[0]!= null && prediccion[1]!= null && prediccion[2]!= null && prediccion[3]!= null && prediccion[4]!= null){
    ...
    private static void agregarTitulo(Document documento,String titulo) throws DocumentException{
        ...
        preface.add(new Paragraph("A continuacion se presenta el desarrollo para la regresión lineal simple, se muestra la tabla con las operaciones necesarias, algunas variables de gran importancia y la prediccion de las variables.", smallBold));
